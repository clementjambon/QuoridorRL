...
The MinMax tree is a classical method for decision making in a zero-sum game. Every edge is an action or move in the game and every node stores the evaluation of a particular state of the game.
