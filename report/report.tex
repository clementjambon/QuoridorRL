...
This section presents a basic decision making approach we propose to solve the game of \textit{Quoridor}. There are two strategies our agent can take whose usages depend on two factors: the first being that you have no more walls to place on the board, and the second being you still do.
