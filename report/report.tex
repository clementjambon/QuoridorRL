...
This section discusses the basic decision making methods developed for our agent. There are two strategies the agent can take whose usages depend on two factors: the first being that you have no more walls to place on the board, and the second being you still do.
