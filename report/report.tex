...
In the former, if no more walls can be placed on the board by your opponent proceed by moving in the shortest-path manner which is calculated with the Djistra method. 
